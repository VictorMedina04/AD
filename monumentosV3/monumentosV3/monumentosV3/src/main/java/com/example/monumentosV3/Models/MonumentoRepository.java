...
public class MonumentoRepository {
    ...
    public void init() {
        ...
        add(Monumento.builder()
                ...
                .imagen("https://upload.wikimedia.org/wikipedia/commons/f/f8/Schloss_Neuschwanstein_2013.jpg")
                .build());
        add(Monumento.builder()
                .id(4L)
                .codigoPais("RU")
                ...
                .imagen("https://upload.wikimedia.org/wikipedia/commons/a/a3/Moscow_Kremlin_view_from_the_cathedral.jpg")
                .build());
        Monumento.builder()
                .id(5L)
                .codigoPais("BR")
                ...
                .imagen("https://upload.wikimedia.org/wikipedia/commons/d/d4/Cristo_Redentor_-_Rio_de_Janeiro%2C_Brasil.jpg")
                .build();
        add(Monumento.builder()
                .id(5L)
                .codigoPais("CN")
                ...
                .imagen("https://upload.wikimedia.org/wikipedia/commons/e/e3/The_Great_Wall_of_China_at_Jinshanling-edit.jpg")
                .build());
    }
    ...
    public List<Monumento> query(double maxLatitud, String sortDirection) {
        ...
        if (maxLatitud < 0) {
            ...
            result = data.stream().filter(m -> m.getLatitud() <= maxLatitud)
